...
public class CategService {
    ...
    public ArrayList<categ> depots;
    public static CategService instance;
    ...
    public static CategService getInstance() {
        if (instance == null) {
            instance = new CategService();
        }
        return instance;
    }
    ...
    public ArrayList<categ> parseDepot(String jsonText) {
        try {
...
p.setPhoto(obj.get("image").toString());
    ...
    public ArrayList<categ> getAllDepot() {
