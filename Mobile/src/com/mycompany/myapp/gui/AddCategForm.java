 ...
 * @author Sandy
 */
public class AddCategForm extends BaseForm {
    ...
    public AddCategForm(com.codename1.ui.util.Resources resourceObjectInstance) {
        ...
        getToolbar().setTitleComponent(
                FlowLayout.encloseCenterMiddle(
                        new Label("Ajout Categorie ", "Title")
                )
        );
        ...
        entreprise.setHint("Titre");
        entreprise.getHintLabel().setUIID("SignupFieldHint");

        row1.addComponent(new Label("Titre :"));
       ...
       */ 
        ...
        ville.setHint("Type");
        ville.getHintLabel().setUIID("SignupFieldHint");
        row2.add(new Label("Type :")).addComponent(ville);
          center.addComponent(row2);
        ...
        capacite.setHint("ID Cat Mere");
        capacite.getHintLabel().setUIID("SignupFieldHint");
        row4.add(new Label("ID Cat Mere :")).addComponent(capacite);
        ...
        Button Ajouter = new Button("Ajouter Categorie");
