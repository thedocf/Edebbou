...
//                System.out.println(rs.getInt(2));
    ...
    private void detailleBonPlan() {
        ...
        Stage stage = new Stage();
        Scene scene = new Scene(new Group());
        stage.setTitle("Reclamations sur produits");
        stage.setWidth(600);
        stage.setHeight(600);
        ...
        chart.setTitle("Reclamations sur produits");
        ((Group) scene.getRoot()).getChildren().add(chart);
        stage.setScene(scene);
...
//        series.getData().add(new XYChart.Data(12, 25));
    ...
    private void convertirPDF(ActionEvent event) throws FileNotFoundException, DocumentException, BadElementException, IOException {
        ...
        try {
            ...
            doc.open();
//            Image img = Image.getInstance("C:\\xampp\\htdocs\\Bon_paln\\web\\uploads\\images\\Sanstitre.png");
